...
my_csv_read_from_file = os.path.join('Resources','budget_data.csv')
...
output_file = os.path.join('Output', 'budget_data_analysis_output.csv')
...
output_file = os.path.join('Output', 'budget_data_analysis_output.txt')
