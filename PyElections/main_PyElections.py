...
my_csv_read_from_file = os.path.join('Resources','election_data.csv')
...
output_file = os.path.join('Output', 'election_data_analysis_output.csv')
...
output_file = os.path.join('Output', 'election_data_analysis_output.txt')
